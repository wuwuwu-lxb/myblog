...
export function GitHubBrandIcon({ size = 19 }: BrandIconProps) {
  return (
...
export function BilibiliBrandIcon({ size = 19 }: BrandIconProps) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
      ...
      width={size}
    >
      <path d="M3 10a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v6a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4v-6Z" />
      <path d="m8 3 2 3" />
      <path d="m16 3-2 3" />
      <path d="M9 13v-1" />
      <path d="M15 13v-1" />
